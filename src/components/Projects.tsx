      ...
      <div className="container-max">
                    ...
                    <div className="flex gap-2">
                      {project.githubUrl && (
                        <a
                          ...
                          className="bg-white/90 hover:bg-white text-gray-900 p-2 rounded-full transition-colors duration-200"
                        >
                  ...
                  <div className="flex gap-3 pt-2">
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-accent-600 hover:text-accent-700 text-sm font-medium flex items-center gap-1 transition-colors duration-200"
                      >
        ...
        <div className="text-center mt-16">
          <p className="text-body text-lg mb-6">
            Want to see more of my work? Check out my GitHub profiles:
          </p>
